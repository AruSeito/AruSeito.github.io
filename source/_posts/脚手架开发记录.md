...
* [x] config中如果已提前输入，则不需要询问用户输入。（20201126完成）
* [ ] 尝试采用并行模式拉取项目，提升效率。
* [ ] 使用typescript改造项目
* [ ] 异常处理模块
* [x] CI/CD。（20201130完成简单的CI，记录可见[CI](https://aruseito.github.io/2021/02/15/travis-ci学习记录/)）
* [ ] 用户输入验证
...
* [ ] EventLoop
* [ ] 线程池
* [ ] 模块化：ES6 CMD AMD CommonJS
* [ ] require 和 import区别
* [ ] 子进程(child_process)

## 20200215更新

遇到的问题中均以有答案，因那段时间在公司比较忙，没时间写文章，因此拖延到近期。
